...
public class UserService implements CRUDUsersServiceMethod{
    ...
    /**
     ...
     @exception IllegalArgumentException if any of the IDs in the provided list do not correspond to any user in the system.
     @exception NullPointerException if any of the UserDTO objects in the provided Hashtable are null.
     */
    @Transactional
    @Override
